...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] transition-colors">
      ...
      <section className="w-full max-w-md rounded-3xl border border-slate-200 tracking-tight p-7 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-10">
        <div className="mb-10">
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          <label className="block text-sm font-medium tracking-tight">
            Email
          ...
          <button className="w-full rounded-xl bg-slate-950 border border-slate-200 px-4 py-3 font-medium text-white transition-colors hover:bg-orange-700" type="submit">Sign in</button>
        </form>
        {/* <div className="mt-7   border-slate-200 pt-5 text-xs leading-5 text-slate-500">
